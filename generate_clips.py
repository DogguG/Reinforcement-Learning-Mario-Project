...
# Hàm giải thích bằng LIME với cập nhật liên tục
def explain_action(state, action, agent, episode, frame_idx):
    ...
    # Cập nhật đồ thị
    plt.draw()
    plt.pause(0.1)  # Tạm dừng 0.1 giây để đồ thị được cập nhật

# Khởi tạo matplotlib ở chế độ tương tác
plt.ion()  # Bật chế độ tương tác
plt.figure(figsize=(10, 5))  # Tạo cửa sổ đồ thị
...
# Tắt chế độ tương tác và đóng cửa sổ khi kết thúc
plt.ioff()
plt.close()